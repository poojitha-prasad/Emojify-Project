...
def show_vid():
    ...
    if flag1==True:
        frame1 = cv2.resize(frame1,(600,500),interpolation = cv2.INTER_AREA)
...
if __name__ == '__main__':
    ...
    heading2=Label(root,text="Photo to Emoji",pady=20, font=('arial',45,'b/old'),bg='black',fg='#CDCDCD')
    ...
    #cap1 = cv2.VideoCapture(r'C:\Users\DELL\Downloads\v1.mp4')
